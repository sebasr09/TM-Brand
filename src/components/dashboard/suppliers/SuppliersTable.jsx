import { Add as AddIcon, DeleteForever as DeleteForeverIcon, VisibilitySharp } from '@mui/icons-material';
import {
  Button,
  Grid,
  IconButton,
...
import SupplierCreate from './createSupplier/SupplierCreate';
  ...
  return (
    <div className={classes.root}>
      ...
      <SuccessSnackbar
        ...
        id='successSnackbar'
      />
      <SupplierCreate open={openCreateUser} handleModifyClose={handleModifyClose} user={selectedUser} isEdit={isEdit} />
      {selectedUser ? (
        <ConfirmationDialog
