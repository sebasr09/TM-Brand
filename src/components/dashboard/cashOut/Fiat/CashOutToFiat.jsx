...
import CashOutTextField from './CashOutTextFieldFiat';
import CashOutMethods from './CashOutMethodsFiat';
    ...
    <div className={classes.root}>
      <Container component='main' maxWidth='md'>
        ...
        >
              ...
              <CardContent>
                <Stack>
                  ...
                  <Typography variant='body2' color={Colors.primary}>
                    Convierte en efectivo tus Copcoins en cualquier momento.
                  </Typography>
                </Stack>
                <Divider />
                <CashOutTextField
          ...
          <Grid item xs={12} md={11} className={classes.centerContainer}>
            <Slide
              direction='up'
              in={open}
              mountOnEnter
            ...
            >
              <Card open={open} onClose={handleClose}>
                <CardContent>
                  <Stack>
                    <Typography variant='h5' color={Colors.primary}>
                      <strong>Métodos de retiro</strong>
                    </Typography>
                    <Typography variant='body2' color={Colors.primary}>
                      Selecciona la entidad con la que quieres recibir tu
                      dinero.
                    </Typography>
                  </Stack>
                  <Divider />
                  <CashOutMethods mainText={'Recargar'} value={value} />
                  <Button
                    variant='contained'
                    color='primary'
                    className={classes.submit}
