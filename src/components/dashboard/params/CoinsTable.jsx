...
import CoinCreate from './createCoin/CoinCreate';
import { makeStyles } from '@mui/styles';
import EnhancedTableHead from './coinTableComponents/EnhancedTableHead';
...
export default function EnhancedTable({ userInfo }) {
  ...
  const handleOpenCreateCoin = () => {
    setOpenCreateCoin(true);
  };

  const handleModifyCloseCoin = () => {
  ...
  return (
    <div className={classes.root}>
      ...
      <CoinCreate open={openCreateCoin} handleModifyClose={handleModifyCloseCoin} userInfo={userInfo} setInformationMessage={setInformationMessage} setOpenInformation={setOpenInformation} />
      <React.Fragment>
        ...
        <Paper className={classes.paper}>
          <EnhancedTableToolbar toggleReDoFetch={toggleReDoFetch} title={"Monedas"}/>
          <TableContainer>
            <Table
              stickyHeader
                  ...
                  .map((row, index) => {
                    return (
                      <TableRow hover role='checkbox' tabIndex={-1} key={index} id={`userDetail${index}`}>
                        ...
                        <TableCell>{row.is_digital_asset ? 'Si': 'No'}</TableCell>
                      </TableRow>
                    );
                  })}
              </TableBody>
