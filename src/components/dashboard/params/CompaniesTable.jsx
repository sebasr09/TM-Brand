...
import CompanyCreate from './createCompany/CompanyCreate';
import { makeStyles } from '@mui/styles';
import EnhancedTableHead from './companyTableComponents/EnhancedTableHead';
...
export default function EnhancedTable({ userInfo }) {
  ...
  const handleModifyCloseCompany = () => {
  ...
  return (
    <div className={classes.root}>
      ...
      <CompanyCreate open={openCreateCompany} handleModifyClose={handleModifyCloseCompany} userInfo={userInfo} setInformationMessage={setInformationMessage} setOpenInformation={setOpenInformation} />
      <React.Fragment>
        ...
        <Paper className={classes.paper}>
          <EnhancedTableToolbar toggleReDoFetch={toggleReDoFetch} title={"Empresas"}/>
          <TableContainer>
            <Table
              stickyHeader
